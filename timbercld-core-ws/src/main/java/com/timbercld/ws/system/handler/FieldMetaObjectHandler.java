...
public class FieldMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        //创建者
        this.setFieldValByName(CREATOR_ID, AuthorityUtils.getUserId(), metaObject);
        //创建时间
        ...
        //用户ID
        setFieldValByName(USER_ID, AuthorityUtils.getUserId(), metaObject);
        //创建者所属部门
        setFieldValByName(DEPT_ID, AuthorityUtils.getDeptId(), metaObject);
        //子系统编码
        setFieldValByName(SUBSYSTEM_ID, AuthorityUtils.getSubSystemId(), metaObject);
